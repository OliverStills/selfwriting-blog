...
if (!$post) {
    ...
    echo '<!DOCTYPE html><html><head><title>Post Not Found</title><link rel="stylesheet" href="styles.css"></head><body><div class="container-custom" style="padding: 6rem 0;"><h1 style="font-size: 3rem; margin-bottom: 1rem;">Post Not Found</h1><p style="font-size: 1.125rem; color: var(--muted-foreground);"><a href="index.php" style="color: var(--foreground);">← Back to home</a></p></div></body></html>';
    exit;
}
    ...
    <header class="site-header">
        <div class="container-custom">
            <div class="header-content">
                <a href="index.php" class="site-logo">The Fifth State</a>
                <nav class="site-nav">
                    <a href="index.php" class="nav-link">Home</a>
                    <a href="index.php#about" class="nav-link">About</a>
                    <a href="index.php#framework" class="nav-link">Framework</a>
                </nav>
            </div>
        </div>
    </header>
